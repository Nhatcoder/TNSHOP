...
@section('title', 'Đơn hàng chờ giao hàng')
                        ...
                        @if (count($orderWaiting) != 0)
                            <table id="datatable" class="table text-center table-striped table-bordered">
                                ...
                                <tbody class="text-dark">
                                    @foreach ($orderWaiting as $key => $item)
                                        <tr>
                                            <td>{{ $key + 1 }}</td>
