                        ...
                        <div class="toolbox">
                            <div class="toolbox-left">
                                <div class="toolbox-info">
                                    Hiển thị<span> 9 / 56</span> Sản phẩm
                                        ...
                                        <div class="product product-7 text-center">
                                            <figure class="product-media">
                                                ...
                                                <a href="product.html">
                                                    ...
                                                    {{-- @if ($item['product_image'])
                                                        @foreach ($item->product_image as $image)
                                                               <b>{{ $image->image_name }}</b> 
                                                        @endforeach
                                                    @endif --}}

                                                    <img src="{{ asset('uploads/product/') }}" alt="Product image"
                                                        class="product-image">
                                                </a>
                                                ...
                                                <div class="product-action">
                                                    <a href="#" class="btn-product btn-cart"><span>Thêm giỏ
                                                            hàng</span>
                                                    </a>
                                                </div>
                                            </figure>
                                            ...
                                            <div class="product-body">
                                                ...
                                                <h3 class="product-title"><a href="#">{{ $item->title }}</a>
                                                </h3>
                                                ...
                                                {{-- <div class="product-nav product-nav-thumbs">
                                                    <a href="#" class="active">
                                                        <img src="{{ asset('') }}assets_fe/images/products/product-4-thumb.jpg"
                                                            alt="product desc">
                                                    </a>
                                                    <a href="#">
                                                        <img src="{{ asset('') }}assets_fe/images/products/product-4-2-thumb.jpg"
                                                            alt="product desc">
                                                    </a>

                                                    <a href="#">
                                                        <img src="{{ asset('') }}assets_fe/images/products/product-4-3-thumb.jpg"
                                                            alt="product desc">
                                                    </a>
                                                </div> --}}
                                            </div>
                    ...
                    <aside class="col-lg-3 order-lg-first">
                        <div class="sidebar sidebar-shop">
                            <div class="widget widget-clean">
                                ...
                                <a href="#" class="sidebar-filter-clear">Xóa Lọc</a>
